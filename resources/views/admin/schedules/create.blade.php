     ...
     <x-slot name="header">
         ...
         <div class="bg-gradient-to-r from-blue-400 to-indigo-400 shadow-lg rounded-lg p-6 text-center">
             <h2 class="font-bold text-3xl text-white leading-tight">
                 <i class="fas fa-calendar-plus mr-3"></i> {{ __('Tambah Jadwal Dokter Baru') }}
             </h2>
             <p class="text-white text-opacity-90 mt-2 text-md">{{ __('Isi formulir di bawah untuk menambahkan jadwal praktik dokter') }}</p>
         </div>
     </x-slot>
             ...
             <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg border-t-4 border-blue-500">
                 <div class="p-6 text-gray-900">
                     <h3 class="text-2xl font-semibold mb-6 text-blue-700 flex items-center">
                         <i class="fas fa-file-alt mr-3"></i> Formulir Penambahan Jadwal
                     </h3>
                     ...
                     <form method="POST" action="{{ route('admin.schedules.store') }}" class="space-y-6 p-6 bg-blue-50 rounded-lg shadow-inner border border-blue-200">
                         @csrf
                         ...
                         <div>
                             ...
                             <x-text-input id="start_time" name="start_time" type="time" class="mt-1 block w-full border-blue-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm p-2.5" :value="old('start_time')" required />
                         ...
                         <div>
                             ...
                             <x-text-input id="end_time" name="end_time" type="time" class="mt-1 block w-full border-blue-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm p-2.5" :value="old('end_time')" required />
                         ...
                         <div>
                             ...
                             <x-text-input id="max_appointments" name="max_appointments" type="number" class="mt-1 block w-full border-blue-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm p-2.5" :value="old('max_appointments', 0)" min="0" required />
                         ...
                         <div class="flex items-center gap-4 pt-4">
                             <x-primary-button class="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold py-3 px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 transform hover:scale-105">
                                 <i class="fas fa-save mr-2"></i> {{ __('Simpan Jadwal') }}
                             </x-primary-button>
