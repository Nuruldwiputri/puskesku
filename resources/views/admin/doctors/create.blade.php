     ...
     <x-slot name="header">
         ...
         <div class="bg-gradient-to-r from-blue-400 to-indigo-400 shadow-lg rounded-lg p-6 text-center">
             <h2 class="font-bold text-3xl text-white leading-tight">
                 <i class="fas fa-user-plus mr-3"></i> {{ __('Tambah Dokter Baru') }}
             </h2>
             <p class="text-white text-opacity-90 mt-2 text-md">{{ __('Isi formulir di bawah untuk menambahkan data dokter baru') }}</p>
         </div>
     </x-slot>
             ...
             <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg border-t-4 border-blue-500">
                 <div class="p-6 text-gray-900">
                     <h3 class="text-2xl font-semibold mb-6 text-blue-700 flex items-center">
                         <i class="fas fa-file-medical mr-3"></i> Formulir Penambahan Dokter
                     </h3>
                     ...
                     <form method="POST" action="{{ route('admin.doctors.store') }}" class="space-y-6 p-6 bg-blue-50 rounded-lg shadow-inner border border-blue-200">
                         @csrf

                         {{-- Name Input --}}
                         <div>
                             <x-input-label for="name" :value="__('Nama Dokter')" class="text-blue-700 font-medium mb-2" />
                             <x-text-input id="name" name="name" type="text" class="mt-1 block w-full border-blue-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm p-2.5" :value="old('name')" required autofocus placeholder="Masukkan nama lengkap dokter" />
                         ...
                         <div>
                             ...
                             <x-text-input id="specialization" name="specialization" type="text" class="mt-1 block w-full border-blue-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm p-2.5" :value="old('specialization')" required placeholder="Contoh: Umum, Gigi, Anak, dll." />
                         ...
                         <div>
                             ...
                             <x-text-input id="phone_number" name="phone_number" type="text" class="mt-1 block w-full border-blue-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm p-2.5" :value="old('phone_number')" placeholder="Contoh: 081234567890" />
                         ...
                         <div>
                             ...
                             <x-text-input id="email" name="email" type="email" class="mt-1 block w-full border-blue-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm p-2.5" :value="old('email')" placeholder="Contoh: nama.dokter@puskesmas.com" />
                         ...
                         <div class="flex items-center gap-4 pt-4">
                             <x-primary-button class="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold py-3 px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 transform hover:scale-105">
                                 <i class="fas fa-save mr-2"></i> {{ __('Simpan Dokter') }}
                             </x-primary-button>
